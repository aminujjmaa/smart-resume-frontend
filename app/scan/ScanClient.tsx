        ...
        <div className="flex-1 flex flex-col items-center justify-center p-8 animate-fade-in">
          <div className="w-full max-w-md">
            ...
            <div className="space-y-3">
              {STEPS.map((s, i) => {
                const state = getStepState(i, currentStepIdx);
                return (
              ...
              <div className="space-y-6">
                {mode === "file" ? (
                  <div className="space-y-4">
                    <label htmlFor="scan-resume-file-input" className="block text-sm font-medium text-slate-300">Resume File</label>
                    {file ? (
                  ...
                  <div className="space-y-4">
                    <label htmlFor="scan-resume-text-input" className="block text-sm font-medium text-slate-300">Resume Text</label>
                    <textarea
                ...
                <div>
                  <label htmlFor="scan-job-description-input" className="mb-3 block text-sm font-medium text-slate-300">
